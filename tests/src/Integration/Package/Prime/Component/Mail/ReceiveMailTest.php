...
use Derafu\Lib\Core\Package\Prime\Component\Mail\Worker\Receiver\Strategy\ImapReceiverStrategy;
use Derafu\Lib\Core\Package\Prime\Component\Mail\Worker\ReceiverWorker;
...
class ReceiveMailTest extends TestCase
{
    ...
    public function testReceiveMail(): void
    {
        ...
        $envelopes = $this->mail->receive($postman);
